...
static void on_connect_failure(void *mqtt_ctx, MQTTAsync_failureData *resp)
{
    ...
    if (resp != NULL)
    {
        ...
        if (resp->code < 0)
        {
            ...
            LOG_ERROR("Error Detail   : %s", mqtt_client_error_string(resp->code));
        }
        else
        {
            /*
...
//     else if (lost == &mqtt2)
//         mqtt2_connecting = 0;
//     /* If mqtt1 lost -> immediately try mqtt2 */
//     /* Gokul commented the below lines --> 02/05/2026 */

//     // if (lost == &mqtt1)
//     // {
//     //     if (!mqtt2.connected && mqtt2.cfg.enable_mqtt)
//     //     {
//     //         LOG_INFO("[FAILOVER] Connecting mqtt2 broker");
//     //         mqtt_connect(&mqtt2);
//     //     }
//     // }
// }
...
//     printf("current active mqtt1  %d current activemqtt2 %d \n", current_active_mqtt1, current_active_mqtt2);
//     // if (strcmp(status, "connected") == 0)
//     // {
//     //     if (current_active_mqtt1 == 0)
//     //     {
...
//     //             freeReplyObject(rly);
//     //     }
//     //     else if (current_active_mqtt1 == 1)
//     //     {
...
//     //             freeReplyObject(rly);
//     //     }
//     //     else if (current_active_mqtt2 == 0)
//     //     {
//     //         redisReply *rly = redisCommand(ctx, "HSET mqtt_0_status %s %s", "connection_status", status);
//     //         if (rly)
//     //             freeReplyObject(rly);
...
//     //             freeReplyObject(rly);
//     //     }
//     //     else if (current_active_mqtt2 == 1)
//     //     {
//     //         redisReply *rly = redisCommand(ctx, "HSET mqtt_1_status %s %s", "connection_status", status);
//     //         if (rly)
//     //             freeReplyObject(rly);
...
//         int uptime = now - mqtt1_mqtt_conn_time;
...
//     //     //     freeReplyObject(rly);
//     // }
//     // else if (certificate_path_check_mqtt1 == 1)
//     // {
//     //     char uptime_str[64] = {0};
//     //     int uptime = now - mqtt1_mqtt_conn_time;
//     //     int days = uptime / (24 * 3600);
...
//     //     //     freeReplyObject(rly);
//     // }
//     // else if (certificate_path_check_mqtt2 == 1)
//     // {
//     //     int uptime = now - secn_mqtt_conn_time;
